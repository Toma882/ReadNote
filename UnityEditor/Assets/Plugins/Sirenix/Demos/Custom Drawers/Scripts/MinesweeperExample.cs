...
namespace Sirenix.OdinInspector.Demos
{
    ...
    public sealed class MinesweeperAttributeDrawer : OdinAttributeDrawer<MinesweeperAttribute, int>
    {
        ...
        protected override void DrawPropertyLayout(GUIContent label)
        {
            ...
            this.ValueEntry.SmartValue = Mathf.Clamp(SirenixEditorFields.IntField(rect.AlignLeft(rect.width - 80 - 4), "炸弹数量", this.ValueEntry.SmartValue), 1, (BoardSize * BoardSize) / 4);

            // 开始游戏
            if (GUI.Button(rect.AlignRight(80), "开始"))
            {
        ...
        private void Game()
        {
            ...
            // 工具栏
            {
                ...
                if (this.gameOver)
                {
                    ...
                    GUI.Label(rect.AlignTop(20).HorizontalPadding(4).AlignMiddle(18), this.flaggedBombs == this.numberOfBombs ? "你赢了！" : "游戏结束！");
                    GUIHelper.PopContentColor();
                }
            }
