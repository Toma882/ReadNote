...
public class TexturePostprocessor : AssetPostprocessor
{
    private void OnPreprocessTexture()
    {
        ...
        importer.alphaIsTransparency = TexturePreprocessSettings.AlphaIsTransparency;
        importer.ignorePngGamma = TexturePreprocessSettings.IgnorePNGFileGamma;
        importer.npotScale = TexturePreprocessSettings.NonPowerOf2;
        importer.isReadable = TexturePreprocessSettings.ReadWriteEnabled;
        importer.streamingMipmaps = TexturePreprocessSettings.StreamingMipmaps;
        ...
        importer.mipMapsPreserveCoverage = TexturePreprocessSettings.MipMapsPreserveCoverage;
        ...
        importer.textureCompression = TexturePreprocessSettings.Compression;
        importer.crunchedCompression = TexturePreprocessSettings.UseCrunchCompression;
